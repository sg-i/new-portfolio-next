      ...
      <CornerBordersDiv>
        <ul className="grid text-xl gap-4">
          <li className="grid grid-cols-3 gap-5 items-center">
            ...
            <Link
              target="_blank"
              className="col-span-2 p-2 shadow-md rounded-lg bg-white border-zinc-200 border-[1px] hover:bg-zinc-50"
          ...
          <li className="grid grid-cols-3  gap-5 items-center">
            ...
            <div className="col-span-2 p-2 shadow-md rounded-lg bg-white border-zinc-200 border-[1px]">
              <div>i.sgadov@yandex.ru</div>
            </div>
          </li>
        </ul>
      </CornerBordersDiv>
